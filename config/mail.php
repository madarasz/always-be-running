...
return [
    ...
    */
    ...
    | sending an email. You will specify which one you're using for your
    | mailers below. You are free to add additional mailers as needed.
    |
    ...
    */
    ...
    | theme and component paths here, allowing you to customize your emails.
    |
    */

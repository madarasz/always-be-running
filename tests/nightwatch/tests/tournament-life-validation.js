var title = 'Tournament A',
    ...
    nocountry_id = '0';
module.exports = {
    'Tournament A create - validation' : function (browser) {
        browser
    ...
    'Tournament A edit - validation' : function (browser) {
        browser
            .url(browser.launchUrl)
            .useXpath()
            .waitForElementVisible('//body', 3000)
            ...
            .click("//select[@id='location_country']")
            .setValue("//select[@id='location_country']", nocountry)
            .keys(['\uE006'])
            .waitForElementNotVisible("//select[@id='location_us_state']", 1000)
            ...
            .click("//input[@type='submit']")
            .waitForElementVisible('//body', 3000)
            .waitForElementVisible("//li[contains(text(), 'country')]", 1000)
            ...
            .assert.value("//select[@id='location_country']", nocountry_id)
    ...
    'Tournament B edit - validation' : function (browser) {
        browser
            .url(browser.launchUrl)
            .useXpath()
            .waitForElementVisible('//body', 3000)

        ...
        var pageProfile= new Vue({
            ...
            data: {
                ...
                user: {
                    ...
                    prize_owning_text: {!! json_encode($user->prize_owning_text) !!},
                    prize_trading_text: {!! json_encode($user->prize_trading_text) !!},
                    prize_wanting_text: {!! json_encode($user->prize_wanting_text) !!},

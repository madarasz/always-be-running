                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('tournament_type_id', $tournament_types,
                                        old('tournament_type_id') || 1, ['class' => 'form-control']) !!}
                                </div>
                            </div>
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    <br/>
                                    {!! Form::checkbox('decklist', 1, old('decklist') == 1) !!}
                        ...
                        <div class="row {{ old('concluded') == 1 ? '' : 'hidden' }}" id="player-numbers">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('top_number', old('top_number'),
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('location_country', $countries, old('location_country') || 1,
                                ['class' => 'form-control', 'onchange' => 'showUsState()']) !!}
                        </div>
                        <div class="form-group {{ old('location_country') == 840 ? '' : 'hidden'}}" id="select_state">
                            {!! Form::label('location_us_state', 'State') !!}
                            {!! Form::select('location_us_state', $us_states,
                                        old('location_us_state') || 1, ['class' => 'form-control']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('location_city', 'City') !!}
                            {!! Form::text('location_city', old('time'), ['class' => 'form-control', 'placeholder' => 'city']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('location_store', 'Store/venue') !!}
                            {!! Form::text('location_store', old('location_store'),
                                ['class' => 'form-control', 'placeholder' => 'store/venue name']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('location_address', 'Address') !!}
                            {!! Form::text('location_address', old('location_address'),
